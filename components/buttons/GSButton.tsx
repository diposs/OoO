import { Button, useMantineColorScheme, Group, packSx, DefaultProps  } from "@mantine/core";
import { useMediaQuery } from "@mantine/hooks";
import {ColorSchemeToggle } from "../ColorSchemeToggle";

interface GsButtonProps extends DefaultProps {}
interface GsLogoutButtonProps extends DefaultProps {}

export const GsButton = ({ sx, ...rest }:GsButtonProps) =>  {
    const { colorScheme } = useMantineColorScheme();
    const matches = useMediaQuery('(min-width: 48em)');
    return (
        <Group spacing="lg" sx={[...packSx(sx)]}>
